...
SWEP.Attachments = {
	["simple_handmade_sight"] =
		gRust.CreateAttachment(AttachmentType.Sight)
			...
			:SetBone("main")
			:SetPosition(Vector(-0.04, -3.5, 4.0))
			:SetAngle(Angle(180, -90, -90))
			:SetScale(1.15)
			:SetIronSightsPos(Vector(-3.895, -4.2, 1.82))
		...
		["holosight"] =
			gRust.CreateAttachment(AttachmentType.Sight)
				...
				:SetBone("main")
				:SetPosition(Vector(-0.125, -3.0, 4.0))
				:SetAngle(Angle(180, -90, 0))
				:SetIronSightsPos(Vector(-3.855, -4.2, 2.375))
				:SetIronSightsAng(Angle(0, 0, 0))
		...
		["silencer"] =
			gRust.CreateAttachment(AttachmentType.Barrel)
				...
				:SetBone("main")
				:SetPosition(Vector(-0.05, -1.45, 24.5))
